...
try
{
    ...
    AfwDatabase::db_query("ALTER TABLE ".$server_db_prefix."workflow.workflow_stage change   processing_request_responsibility processing_request_responsibility smallint DEFAULT NULL  AFTER time_unit;");
