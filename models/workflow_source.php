...
class WorkflowSource extends WorkflowObject
{
    ...
    public static $TABLE = 'workflow_source';
    ...
    {
        parent::__construct('workflow_source', 'id', 'workflow');
        WorkflowWorkflowSourceAfwStructure::initInstance($this);
    }

    public static function loadById($id)
    {
        $obj = new WorkflowSource();
    ...
    public function select_visibilite_horizontale($dropdown = false)
    {
        ...
        /* Amjad whatsapp 18/01/2026 7pm ~ audio say do not limit for users for the moment
            ...
            if ($employee_id) {
                ...
                if ($wEmplObj) {
                    $wsource_mfk = trim($wEmplObj->getVal("wsource_mfk"), ",");
                    $this->where("id in ($wsource_mfk)");
                }
            }
        }*/
