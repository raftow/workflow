...
class InterviewTypePattern extends WorkflowObject
{

    //public static $MY_ATABLE_ID=14056; 

    public static $DATABASE        = "nauss_workflow";
    public static $MODULE                = "workflow";
    public static $TABLE            = "interview_type_pattern";

    public static $DB_STRUCTURE = null;

    public function __construct()
    {
        parent::__construct("interview_type_pattern", "id", "workflow");
        WorkflowInterviewTypePatternAfwStructure::initInstance($this);
    }

    public static function loadById($id)
    {
        $obj = new InterviewTypePattern();
    ...
    public static function loadByMainIndex($workflow_stage_id, $create_obj_if_not_found = false)
    {
