...
class InterviewSlotStatusArTranslator
{
	public static function initData()
	{
		...
		$trad["interview_slot_status"]["interviewslotstatus.single"] = "حالة موعد";
		$trad["interview_slot_status"]["interviewslotstatus.new"] = "جديدة";
		$trad["interview_slot_status"]["interview_slot_status"] = "حالات المواعيد";
