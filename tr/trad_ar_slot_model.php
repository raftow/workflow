...
class SlotModelArTranslator{
    public static function initData()
    {
		...
		$trad["slot_model"]["application_plan_id"] = "خطة التقديم";
		$trad["slot_model"]["academic_program_id"] = "برنامج الدراسي";
		$trad["slot_model"]["workflow_stage_id_"] = "مرحلة القبول";
		$trad["slot_model"]["interview_date"] = "اليوم";
		$trad["slot_model"]["start_time"] = "وقت البداية	Start Time";
