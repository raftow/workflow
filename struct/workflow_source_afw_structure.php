<?php
class WorkflowWorkflowSourceAfwStructure
{
        ...
        public static function initInstance(&$obj)
        {
                if ($obj instanceof WorkflowSource) {
                        ...
                        $obj->DISPLAY_FIELD = "source_name_ar";
                        ...
                        $obj->after_save_edit = array("mode" => "qsearch", "currmod" => 'workflow', "class" => 'WorkflowSource', "submit" => true);
                } else {
                        WorkflowSourceArTranslator::initData();
                        WorkflowSourceEnTranslator::initData();
                }
        }
