<?php 
        class WorkflowNotificationScheduleAfwStructure
        {
                ...
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof NotificationSchedule) 
                        {
                                $obj->QEDIT_MODE_NEW_OBJECTS_DEFAULT_NUMBER = 3;
                                 $obj->DISPLAY_FIELD = "notification_schedule_name_ar";
                                // $obj->ORDER_BY_FIELDS = "xxxx, yyyy";
                                  $obj->UNIQUE_KEY = array('workflow_module_id','workflow_entity_id','workflow_event_id','notification_template_id');
                                ...
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'workflow', "class"=>'NotificationSchedule',"submit"=>true);
                        }
                        else 
                        {
                                NotificationScheduleArTranslator::initData();
                                NotificationScheduleEnTranslator::initData();
                        }
                }
        ...
        'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
        'CSS' => 'width_pct_25', 'DEPENDENT_OFME' => ['workflow_entity_id','workflow_event_id','notification_template_id']),	
...
'workflow_entity_id' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE' => true,  
        ...
        'DISPLAY' => true,  'STEP' => 1,  'RELATION' => 'ManyToOne-OneToMany', 'MANDATORY' => true, 'READONLY'=>false, 'AUTOCOMPLETE' => false,
        'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
        'CSS' => 'width_pct_25','WHERE' => 'workflow_module_id=§workflow_module_id§',
        'DEPENDENCY' => 'workflow_module_id',
        'DEPENDENT_OFME' => ['workflow_event_id','notification_template_id'] ),	
...
'workflow_event_id' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE' => true,  
        ...
        'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
        'CSS' => 'width_pct_25','WHERE' => 'workflow_module_id=§workflow_module_id§ and workflow_entity_id=§workflow_entity_id§',
        'DEPENDENCIES' => ['workflow_module_id','workflow_entity_id'],
               /* 'DEPENDENT_OFME' => ['notification_template_id']*/ ),	
...
'notification_template_id' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE' => true,  
        ...
        'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
        'CSS' => 'width_pct_25',
        'WHERE' => 'workflow_module_id=§workflow_module_id§ and workflow_entity_id=§workflow_entity_id§',
        'DEPENDENCIES' => ['workflow_module_id','workflow_entity_id'], ),	
