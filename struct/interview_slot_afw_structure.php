<?php 
        ...
        class WorkflowInterviewSlotAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof InterviewSlot ) 
                        {
                                ...
                                $obj->ORDER_BY_FIELDS = "";
                                 ...
                                 $obj->UNIQUE_KEY = array("slot_model_id", "interview_date", "start_time");
                                
                $obj->showQeditErrors = true;
                $obj->showRetrieveErrors = true;
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'InterviewSlot',"attribute"=>'xxxx_id', "currmod"=>'workflow',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'workflow', "class"=>'InterviewSlot',"submit"=>true);
                        }
                        else 
                        {
                                InterviewSlotArTranslator::initData();
                                InterviewSlotEnTranslator::initData();
                        }
                }
     ...
     array(
		...
		'duration' => array('SEARCH' => true,  'QSEARCH' => false,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => false,  
				'EDIT' => true,  'QEDIT' => false,  
				'SIZE' => 32,  'MAXLENGTH' => 32,  'MIN-SIZE' => 1,  'CHAR_TEMPLATE' => "ALPHABETIC,SPACE",  'MANDATORY' => true,  'UTF8' => false,  
		...
		'interview_type' => array('SEARCH' => true,  'QSEARCH' => true,  'SHOW' => true,  'AUDIT' => false,  'RETRIEVE' => false,  
				'EDIT' => true,  'QEDIT' => false,  
				'SIZE' => 32,  'MAXLENGTH' => 32,  'MIN-SIZE' => 1,  'CHAR_TEMPLATE' => "ALPHABETIC,SPACE",  'MANDATORY' => true,  'UTF8' => false,  
