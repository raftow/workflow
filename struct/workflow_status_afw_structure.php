...
class WorkflowWorkflowStatusAfwStructure
{
        ...
        public static function initInstance(&$obj)
        {
                if ($obj instanceof WorkflowStatus) {
                        ...
                        $obj->after_save_edit = array("mode" => "qsearch", "currmod" => 'workflow', "class" => 'WorkflowStatus', "submit" => true);
                } else {
