<?php 
        ...
        class WorkflowSectionTemplateAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof SectionTemplate ) 
                        {
                                ...
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'workflow', "class"=>'SectionTemplate',"submit"=>true);
                        }
                        else 
                        {
                                SectionTemplateArTranslator::initData();
                                SectionTemplateEnTranslator::initData();
                        }
                }
