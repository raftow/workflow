...
class WorkflowWorkflowCommiteeAfwStructure
{
        ...
        public static function initInstance(&$obj)
        {
                if ($obj instanceof WorkflowCommitee) {
                        ...
                        $obj->after_save_edit = array("mode" => "qsearch", "currmod" => 'workflow', "class" => 'WorkflowCommitee', "submit" => true);
                } else {
        ...
        public static $DB_STRUCTURE = array(
                ...
                'workflowCommiteeMemberList' => array(
                        'TYPE' => 'FK',
                        'ANSWER' => 'workflow_commitee_member',
                        'STEP' => 2,
                        'ANSMODULE' => 'workflow',
                        'CATEGORY' => 'ITEMS',
                        'ITEM' => 'workflow_commitee_id',
                ...
                'workflowCommiteeScopeList' => array(
                        'TYPE' => 'FK',
                        'ANSWER' => 'workflow_commitee_scope',
                        'STEP' => 3,
                        'ANSMODULE' => 'workflow',
                        'CATEGORY' => 'ITEMS',
                        'ITEM' => 'workflow_commitee_id',
