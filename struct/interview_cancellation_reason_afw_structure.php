<?php 
        ...
        class WorkflowInterviewCancellationReasonAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof InterviewCancellationReason ) 
                        {
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'InterviewCancellationReason',"attribute"=>'xxxx_id', "currmod"=>'workflow',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'workflow', "class"=>'InterviewCancellationReason',"submit"=>true);
                        }
                        else 
                        {
                                InterviewCancellationReasonArTranslator::initData();
                                InterviewCancellationReasonEnTranslator::initData();
                        }
                }
