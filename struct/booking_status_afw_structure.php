<?php 
        ...
        class WorkflowBookingStatusAfwStructure
        {
                // token separator = §
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'BookingStatus',"attribute"=>'xxxx_id', "currmod"=>'workflow',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'workflow', "class"=>'BookingStatus',"submit"=>true);
                        }
                        else 
                        {
                                BookingStatusArTranslator::initData();
                                BookingStatusEnTranslator::initData();
                        }
                }
