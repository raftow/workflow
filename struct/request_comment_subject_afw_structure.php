...
class WorkflowRequestCommentSubjectAfwStructure
{
        // token separator = §
        public static function initInstance(&$obj)
        {
                if ($obj instanceof RequestCommentSubject) {
                        ...
                        // $obj->after_save_edit = array("class"=>'RequestCommentSubject',"attribute"=>'xxxx_id', "currmod"=>'workflow',"currstep"=>2);
                        $obj->after_save_edit = array("mode" => "qsearch", "currmod" => 'workflow', "class" => 'RequestCommentSubject', "submit" => true);
                } else {
                        RequestCommentSubjectArTranslator::initData();
                        RequestCommentSubjectEnTranslator::initData();
                }
        }
