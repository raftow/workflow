<?php 
        class WorkflowWorkflowStageAfwStructure
        {
                ...
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof WorkflowStage) 
                        {
                                ...
                                // $obj->ORDER_BY_FIELDS = "xxxx, yyyy";
                                  $obj->UNIQUE_KEY = array('workflow_model_id','step_code');
                                ...
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'adm', "class"=>'WorkflowStage',"submit"=>true);
                        }
                        else 
                        {
                                WorkflowStageArTranslator::initData();
                                WorkflowStageEnTranslator::initData();
                        }
                }
...
'workflow_stage_name_ar' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE-AR' => true,  
...
'workflow_stage_name_en' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE-EN' => true,  
...
'workflow_stage_desc_ar' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE' => false,  
...
'workflow_stage_desc_en' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE' => false,  
...
'required_application_field_mfk' => array(
        'IMPORTANT' => 'IN',
        'SHOW' => true,
        'RETRIEVE' => false,
        'QEDIT' => true,
...
'processing_request_responsibility' => array('IMPORTANT' => 'IN',  'SEARCH' => true, 'QSEARCH' => true, 'SHOW' => true,  'RETRIEVE-AR' => true,  
        'EDIT' => true,  'QEDIT' => true,  'SIZE' => '100', 'MAXLENGTH' => '100', 'UTF8' => true,  
        'TYPE' => 'TEXT',    'DISPLAY' => true,  'STEP' => 1, 'MANDATORY' => false,  
        'DISPLAY-UGROUPS' => '',  'EDIT-UGROUPS' => '', 
        'CSS' => 'width_pct_25',),
