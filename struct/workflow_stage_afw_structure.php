...
class WorkflowWorkflowStageAfwStructure
{
        ...
        public static $DB_STRUCTURE = array(
                ...
                'orgunit_id' => array(
                        ...
                        'ANSWER' => 'orgunit',
                        'ANSMODULE' => 'hrm',
                        'WHERE' => "id=12420 or id in (select orgunit_id from §DBPREFIX§workflow.workflow_orgunit where active='Y')",
                        'RELATION' => 'ManyToOne',
                        'READONLY' => false,
                        'DISPLAY' => true,
                        'DISPLAY-UGROUPS' => '',
                ...
                'processing_request_responsibility' => array(
                        'IMPORTANT' => 'IN',
                        'SEARCH' => true,
                        'QSEARCH' => true,
                        'SHOW' => true,
