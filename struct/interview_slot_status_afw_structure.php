<?php 
        ...
        class WorkflowInterviewSlotStatusAfwStructure
        {
                // token separator = §
                public static function initInstance(&$obj)
                {
                        if ($obj instanceof InterviewSlotStatus ) 
                        {
                ...
                $obj->general_check_errors = true;
                                // $obj->after_save_edit = array("class"=>'InterviewSlotStatus',"attribute"=>'xxxx_id', "currmod"=>'workflow',"currstep"=>2);
                                $obj->after_save_edit = array("mode"=>"qsearch", "currmod"=>'workflow', "class"=>'InterviewSlotStatus',"submit"=>true);
                        }
                        else 
                        {
                                InterviewSlotStatusArTranslator::initData();
                                InterviewSlotStatusEnTranslator::initData();
                        }
                }
