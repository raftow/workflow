...
class WorkflowWorkflowActionAfwStructure
{
        ...
        public static function initInstance(&$obj)
        {
                if ($obj instanceof WorkflowAction) {
                        ...
                        $obj->after_save_edit = array("mode" => "qsearch", "currmod" => 'workflow', "class" => 'WorkflowAction', "submit" => true);
                } else {
